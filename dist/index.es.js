...
function DatasTable(props) {
  ...
  function createTBody(datas) {
    ...
    let result = datas.map((e, i) => {
      ...
      let row = props.head.map((h, y) => {
        return /*#__PURE__*/React.createElement("td", null, e[h.key]);
      });
      return /*#__PURE__*/React.createElement("tr", null, row);
    });
    return result;
  }
  ...
  }, "Chercher"))), /*#__PURE__*/React.createElement("table", null, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, head)), /*#__PURE__*/React.createElement("tbody", null, tableBody)), /*#__PURE__*/React.createElement("div", {
    class: "flex_container"
  ...
  }, totalPage <= 5 ? 1 : currentPage > totalPage - 4 ? totalPage - 4 : currentPage), /*#__PURE__*/React.createElement("span", {
  ...
  }, totalPage <= 5 ? 2 : currentPage > totalPage - 4 ? totalPage - 3 : currentPage + 1), /*#__PURE__*/React.createElement("span", {
  ...
  }, totalPage <= 5 ? 3 : currentPage > totalPage - 4 ? totalPage - 2 : currentPage + 2), /*#__PURE__*/React.createElement("span", {
  ...
  }, totalPage <= 5 ? 4 : currentPage > totalPage - 4 ? totalPage - 1 : currentPage + 3), /*#__PURE__*/React.createElement("span", {
  ...
  }, totalPage <= 5 ? 5 : currentPage > totalPage - 4 ? totalPage : currentPage + 4), /*#__PURE__*/React.createElement("span", {
